!function (e) {
  function n(n) {
    for (var s, o, l = n[0], r = n[1], d = n[2], u = 0, m = []; u < l.length; u++) o = l[u], Object.prototype.hasOwnProperty.call(i, o) && i[o] && m.push(i[o][0]), i[o] = 0;
    for (s in r) Object.prototype.hasOwnProperty.call(r, s) && (e[s] = r[s]);
    for (c && c(n); m.length;) m.shift()();
    return a.push.apply(a, d || []), t()
  }

  function t() {
    for (var e, n = 0; n < a.length; n++) {
      for (var t = a[n], s = !0, l = 1; l < t.length; l++) {
        var r = t[l];
        0 !== i[r] && (s = !1)
      }
      s && (a.splice(n--, 1), e = o(o.s = t[0]))
    }
    return e
  }
  ...
  function o(n) {
    ...
    var t = s[n] = {i: n, l: !1, exports: {}};
    return e[n].call(t.exports, t, t.exports, o), t.l = !0, t.exports
  }

  o.m = e, o.c = s, o.d = function (e, n, t) {
  ...
  12: function (e, n, t) {
    ...
    class r {
      constructor() {
        l(this, "element", void 0), l(this, "subElements", {}), this.render(), this.getSubElements(), this.initEventListeners()
      }

      render() {
        const e = document.createElement("div");
        e.innerHTML = '\n      <div>\n        <h1>Login Page</h1>\n        <a class="router" href="/profile">\n          <div data-id="navigationBtn">Go to next page</div>\n        </a>\n      </div>\n    ', this.element = e.firstElementChild
      }

      getSubElements() {
        const e = this.element.querySelectorAll("[data-id]");
        for (const n of e) this.subElements[n.dataset.id] = n
      }
    ...
    t(10), t(13);
    c.a.initializeApp({
      apiKey: "AIzaSyCte0dEwjImv8Gi-nQYvcjYu1_hql2dqtw",
      authDomain: "sos-app-21bc9.firebaseapp.com",
      databaseURL: "https://sos-app-21bc9.firebaseio.com",
      projectId: "sos-app-21bc9",
      storageBucket: "sos-app-21bc9.appspot.com",
      messagingSenderId: "77409901091",
      appId: "1:77409901091:web:9ddea37db73235db3caf96",
      measurementId: "G-83CSKJ236M"
    }), c.a.analytics(), console.error("firebase", c.a);
    new class {
      constructor(e) {
        this.routes = e, this.initEventListeners(), this.renderPage(window.location.pathname)
      }

      initEventListeners() {
        document.addEventListener("click", e => {
          const {target: n} = e, t = n.closest("a");
          if (t && "router" === t.className) {
            const n = t.getAttribute("href");
            n.startsWith("/") && (e.preventDefault(), history.pushState(null, null, n), this.renderPage(n))
          }
        }), window.addEventListener("popstate", e => {
          const {target: n} = e;
          this.renderPage(n.location.pathname)
        })
      }

      renderPage(e) {
        const n = this.routes[e];
        s.innerHTML = "", s.append(n.element)
      }
    }({
      "/sos-app": new r, "/sos-app/": new r, "/sos-app/profile": new class {
        constructor() {
          var e, n, t;
          t = void 0, (n = "element") in (e = this) ? Object.defineProperty(e, n, {
            value: t,
            enumerable: !0,
            configurable: !0,
            writable: !0
      ...
      constructor() {
        i(this, "element", void 0), i(this, "subElements", void 0), this.render(), this.getSubElements(), this.initEventListeners()
      }
      ...
      getSubElements() {
        const e = {}, n = this.element.querySelectorAll("[data-id");
        for (const t of n) e[t.dataset.id] = t;
        this.subElements = e
      }

      initEventListeners() {
        const {closeModalBtn: e} = this.subElements;
      ...
      constructor() {
        a(this, "element", void 0), a(this, "subElements", void 0), this.render(), this.getSubElements(), this.initEventListeners()
      }
      ...
      constructor() {
        o(this, "element", void 0), o(this, "subElements", void 0), this.render(), this.getSubElements(), this.initEventListeners()
      }
